<form action="{{ !empty($user) ? route('admin.userSupport.update') : route('admin.userSupport.save') }}" method="post"
        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group" id="category-name-field">
                    ...
                    <input type="text" name="question" class="form-control" id="question"
                        placeholder="Enter Question" value="{{ !empty($user->question) ? $user->question : '' }}"
                        required>
                </div>
            </div>
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <textarea name="answer" class="form-control" id="categoryDescription">{!! !empty($user->answer) ? $user->answer : '' !!}</textarea>
                </div>
            </div>
        </div>
    </div>
